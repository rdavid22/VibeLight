...
public class DymeServiceConnection
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Dyme.Services.DymeServiceConnection, DymeAndroidService", DymeServiceConnection.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == DymeServiceConnection.class)
			mono.android.TypeManager.Activate ("Dyme.Services.DymeServiceConnection, DymeAndroidService", "", this, new java.lang.Object[] {  });
	}
